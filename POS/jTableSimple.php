    ...
    $(document).ready(function () {
        ...
        $('#StudentTableContainer').jtable({
           ...
           actions: {
					...
					{
					?>
					listAction: 'PersonActions.php?action=listso',
					<?php
					}
                        ...
                        $img.click(function () {
                            $('#StudentTableContainer').jtable('openChildTable',
                                    $img.closest('tr'),
                                    {
										...
										{
										?>
										listAction: 'PersonActions.php?action=listpos&SO_ID='+studentData.record.SO_ID,
										<?php
										}
										if ($_SESSION['session_prv_POS_MMGT'] == "Y")
										{	
										?>
										createAction: 'PersonActions.php?action=createpos&SO_ID='+studentData.record.SO_ID,
										updateAction: 'PersonActions.php?action=updatepos',
										deleteAction: 'PersonActions.php?action=deletepos',
										<?php
										}
										}
										?>
                        ...
                        $img.click(function () {
                            $('#StudentTableContainer').jtable('openChildTable',
                                    ...
                                    title:"POS" + studentData1.record.POS_ID + studentData1.record.POS_DEV_TYPE,
										...
										{
										?>
										listAction: 'PersonActions.php?action=listsrv&POS_DEV_ID='+studentData1.record.POS_DEV_ID,
										<?php
										}
										if ($_SESSION['session_prv_POS_MMGT'] == "S")
										{	
										?>
										createAction: 'PersonActions.php?action=create',
										updateAction: 'PersonActions.php?action=update',
										deleteAction: 'PersonActions.php?action=deletesrv'
										<?php
										}
										}
										?>
